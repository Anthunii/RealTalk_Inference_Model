...
## How It Works
1. **Preprocessing** (`Wav2Spec.ipynb`) – Input audio is converted into a log-mel spectrogram  
2. **Model Inference** (`model_inference.py`) – The spectrogram is passed through the Vision Transformer  
3. **Classification** (`app.py`) – The model outputs whether the audio is *Real* or *Deepfake*  (to be deployed)
